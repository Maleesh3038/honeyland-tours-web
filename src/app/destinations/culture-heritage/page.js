  ...
  return (
    <main className="min-h-screen bg-[#FDFCF7] text-[#2D2A22] pb-20">
      <div className="relative w-full h-[50vh] bg-[#1A1512]">
        <Image src="/culture-cover.jpg" alt="Cultural & Historical Heritage" fill priority className="object-cover opacity-60" />
        ...
        <div className="absolute bottom-8 left-0 w-full px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-3xl md:text-5xl font-serif font-black text-[#2D2A22]">Cultural & Historical Heritage</h1>
            <p className="text-xs md:text-sm text-[#C19A5B] font-bold uppercase tracking-wider mt-1">Journey through 2500+ years of ancient majesty</p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-6 mt-12 grid grid-cols-1 md:grid-cols-3 gap-10">
        <div className="md:col-span-2 space-y-6">
          ...
          <p className="text-sm md:text-base text-[#666053] leading-relaxed">
            Immerse yourself in Sri Lanka's rich historical legacy. Explore the breathtaking Sigiriya Rock Fortress, pay respects at the sacred Temple of the Tooth in Kandy, and wander the colonial ramparts of the UNESCO-listed Galle Fort. Our drivers will ensure a smooth journey across the Cultural Triangle.
          </p>
        </div>
        <div className="bg-white p-6 rounded-2xl border border-[#EFECE3] shadow-sm h-fit">
          ...
          <p className="text-xs text-[#666053] mb-4">Book a safe private ride with our personal driver to explore these historical locations seamlessly.</p>
      ...
      <div className="max-w-4xl mx-auto px-6 mt-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[
            { src: "/sigiriya-rock.jpg", title: "Sigiriya Fortress" },
            { src: "/kandy-temple.jpg", title: "Temple of the Tooth" },
            { src: "/galle-fort.jpg", title: "Historic Galle Fort" }
          ].map((item, index) => (
