...
export default function WildlifeNaturePage() {
  return (
    <main className="min-h-screen bg-[#FDFCF7] text-[#2D2A22] pb-20">
      <div className="relative w-full h-[50vh] bg-[#1A1512]">
        <Image src="/wildlife-cover.jpg" alt="Wildlife Safari & Nature" fill priority className="object-cover opacity-60" />
        ...
        <div className="absolute bottom-8 left-0 w-full px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-3xl md:text-5xl font-serif font-black text-[#2D2A22]">Wildlife Safari & Nature</h1>
            <p className="text-xs md:text-sm text-[#C19A5B] font-bold uppercase tracking-wider mt-1">Meet the giants of the wild in their natural habitat</p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-6 mt-12 grid grid-cols-1 md:grid-cols-3 gap-10">
        <div className="md:col-span-2 space-y-6">
          ...
          <p className="text-sm md:text-base text-[#666053] leading-relaxed">
            Experience the vibrant biodiversity of paradise. Track elusive leopards in Yala National Park, witness the incredible annual elephant gathering in Minneriya, and explore the dense endemics of the Sinharaja Rainforest. We plan stress-free private transport right up to the safari gates.
          </p>
        </div>
        <div className="bg-white p-6 rounded-2xl border border-[#EFECE3] shadow-sm h-fit">
          ...
          <p className="text-xs text-[#666053] mb-4">Book a safe private ride with our personal driver to explore these natural reserves seamlessly.</p>
      ...
      <div className="max-w-4xl mx-auto px-6 mt-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[
            { src: "/yala-leopard.jpg", title: "Yala Leopard Safari" },
            { src: "/minneriya-elephants.jpg", title: "Minneriya Gathering" },
            { src: "/sinharaja-rainforest.jpg", title: "Sinharaja Forest" }
          ].map((item, index) => (
