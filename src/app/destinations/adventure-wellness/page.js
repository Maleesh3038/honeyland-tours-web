...
export default function AdventureWellnessPage() {
  return (
    <main className="min-h-screen bg-[#FDFCF7] text-[#2D2A22] pb-20">
      {/* Hero Section */}
      <div className="relative w-full h-[50vh] bg-[#1A1512]">
        <Image src="/adventure-cover.jpg" alt="Adventure & Wellness" fill priority className="object-cover opacity-60" />
        ...
        <div className="absolute bottom-8 left-0 w-full px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-3xl md:text-5xl font-serif font-black text-[#2D2A22]">Adventure & Wellness</h1>
            <p className="text-xs md:text-sm text-[#C19A5B] font-bold uppercase tracking-wider mt-1">Thrilling hikes meets peaceful Ayurveda rejuvenation</p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-6 mt-12 grid grid-cols-1 md:grid-cols-3 gap-10">
        <div className="md:col-span-2 space-y-6">
          ...
          <p className="text-sm md:text-base text-[#666053] leading-relaxed">
            Find the perfect holiday balance. Get your adrenaline pumping with thrilling white-water rafting down Kitulgala's rapids, soar above Ella's green valleys on the Flying Ravana zipline, and completely reset with deep, authentic Ayurveda spa therapies and yoga sessions.
          </p>
        </div>
        <div className="bg-white p-6 rounded-2xl border border-[#EFECE3] shadow-sm h-fit">
          ...
          <p className="text-xs text-[#666053] mb-4">Book a safe private ride with our personal driver to experience action and wellness seamlessly.</p>
      ...
      <div className="max-w-4xl mx-auto px-6 mt-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[
            { src: "/kitulgala-rafting.jpg", title: "Kitulgala Rafting" },
            { src: "/ella-zipline.jpg", title: "Ella Flying Ravana" },
            { src: "/ayurveda-spa.jpg", title: "Ayurveda Wellness" }
          ].map((item, index) => (
