...
export default function MountainsTeaPage() {
  return (
    <main className="min-h-screen bg-[#FDFCF7] text-[#2D2A22] pb-20">
      <div className="relative w-full h-[50vh] bg-[#1A1512]">
        <Image src="/mountains-cover.jpg" alt="Misty Mountains & Tea Plantations" fill priority className="object-cover opacity-60" />
        ...
        <div className="absolute bottom-8 left-0 w-full px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-3xl md:text-5xl font-serif font-black text-[#2D2A22]">Misty Mountains & Tea Plantations</h1>
            <p className="text-xs md:text-sm text-[#C19A5B] font-bold uppercase tracking-wider mt-1">Breathtaking viewpoints, waterfalls, and lush tea trails</p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-6 mt-12 grid grid-cols-1 md:grid-cols-3 gap-10">
        <div className="md:col-span-2 space-y-6">
          ...
          <p className="text-sm md:text-base text-[#666053] leading-relaxed">
            Escape into the cool hill country. Walk along the iconic Nine Arch Bridge in Ella, tour the beautifully manicured tea factories of Nuwara Eliya, or embark on a midnight pilgrimage up Adam's Peak for an unforgettable golden sunrise. Enjoy stunning mountain drives with our experienced chauffeurs.
          </p>
        </div>
        <div className="bg-white p-6 rounded-2xl border border-[#EFECE3] shadow-sm h-fit">
          ...
          <p className="text-xs text-[#666053] mb-4">Book a safe private ride with our personal driver to explore these mountain destinations seamlessly.</p>
      ...
      <div className="max-w-4xl mx-auto px-6 mt-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[
            { src: "/ella-ninearch.jpg", title: "Nine Arch Bridge" },
            { src: "/nuwaraeliya-tea.jpg", title: "Nuwara Eliya Tea Estates" },
            { src: "/adamspeak-sunrise.jpg", title: "Adam's Peak Sunrise" }
          ].map((item, index) => (
