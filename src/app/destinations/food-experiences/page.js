  ...
  return (
    <main className="min-h-screen bg-[#FDFCF7] text-[#2D2A22] pb-20">
      <div className="relative w-full h-[50vh] bg-[#1A1512]">
        <Image src="/food-cover.jpg" alt="Authentic Sri Lankan Food Experiences" fill priority className="object-cover opacity-60" />
        ...
        <div className="absolute bottom-8 left-0 w-full px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-3xl md:text-5xl font-serif font-black text-[#2D2A22]">Authentic Sri Lankan Food</h1>
            <p className="text-xs md:text-sm text-[#C19A5B] font-bold uppercase tracking-wider mt-1">Taste the rich spices and traditional flavors of paradise</p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-6 mt-12 grid grid-cols-1 md:grid-cols-3 gap-10">
        <div className="md:col-span-2 space-y-6">
          ...
          <p className="text-sm md:text-base text-[#666053] leading-relaxed">
            Take your tastebuds on an island adventure. Taste legendary street food like crispy Egg Hoppers and sizzling Kottu Roti, enjoy an authentic traditional Rice & Curry feast served on lotus leaves, or indulge in fresh, locally caught beachside seafood in Mirissa. Our drivers know the safest and finest local food hubs.
          </p>
        </div>
        <div className="bg-white p-6 rounded-2xl border border-[#EFECE3] shadow-sm h-fit">
          ...
          <p className="text-xs text-[#666053] mb-4">Book a safe private ride with our personal driver to explore local food trails seamlessly.</p>
      ...
      <div className="max-w-4xl mx-auto px-6 mt-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[
            { src: "/streetfood-kottu.jpg", title: "Island Street Food" },
            { src: "/rice-curry.jpg", title: "Traditional Rice & Curry" },
            { src: "/mirissa-seafood.jpg", title: "Fresh Coast Seafood" }
          ].map((item, index) => (
