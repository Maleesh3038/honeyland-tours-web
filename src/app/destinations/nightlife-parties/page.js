...
export default function NightlifePartiesPage() {
  return (
    <main className="min-h-screen bg-[#FDFCF7] text-[#2D2A22] pb-20">
      <div className="relative w-full h-[50vh] bg-[#1A1512]">
        <Image src="/nightlife-cover.jpg" alt="Nightlife & Beach Parties" fill priority className="object-cover opacity-60" />
        ...
        <div className="absolute bottom-8 left-0 w-full px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-3xl md:text-5xl font-serif font-black text-[#2D2A22]">Nightlife & Beach Parties</h1>
            <p className="text-xs md:text-sm text-[#C19A5B] font-bold uppercase tracking-wider mt-1">Dance under the stars at the best coastal hotspots</p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-6 mt-12 grid grid-cols-1 md:grid-cols-3 gap-10">
        <div className="md:col-span-2 space-y-6">
          ...
          <p className="text-sm md:text-base text-[#666053] leading-relaxed">
            Experience the vibrant nocturnal energy of the island. Unwind at high-end Colombo rooftop bars overlooking the city skyline, or dance to international beats at legendary Hikkaduwa beach parties and vibrant Mirissa night clubs. Our reliable 24/7 designated drivers ensure you return to your hotel safely.
          </p>
        </div>
        <div className="bg-white p-6 rounded-2xl border border-[#EFECE3] shadow-sm h-fit">
          ...
          <p className="text-xs text-[#666053] mb-4">Book a safe private ride with our personal driver to explore local nightlife locations seamlessly.</p>
      ...
      <div className="max-w-4xl mx-auto px-6 mt-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[
            { src: "/colombo-rooftop.jpg", title: "Colombo Rooftops" },
            { src: "/hikkaduwa-beachparty.jpg", title: "Hikkaduwa Beach Party" },
            { src: "/mirissa-club.jpg", title: "Vibrant Night Clubs" }
          ].map((item, index) => (
